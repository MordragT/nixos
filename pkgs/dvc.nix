{
  ...
  hydra-core = python3.pkgs.buildPythonPackage rec {
    pname = "hydra-core";
    version = "1.3.0";
  ...
  iterative-telemetry = python3.pkgs.buildPythonPackage rec {
  ...
  dvc-objects = python3.pkgs.buildPythonPackage rec {
    pname = "dvc-objects";
    version = "0.14.0";
    format = "pyproject";
  ...
  dvc-http = python3.pkgs.buildPythonPackage rec {
    pname = "dvc-http";
    version = "2.27.2";
    format = "pyproject";
  ...
  dvc-data = python3.pkgs.buildPythonPackage rec {
    pname = "dvc-data";
    version = "0.28.4";
    format = "pyproject";
  ...
  dvc-render = python3.pkgs.buildPythonPackage rec {
    pname = "dvc-render";
    version = "0.0.16";
    format = "pyproject";
