...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    boot.kernelParams = lib.optionals cfg.thp [
    ...
    # V4l2 Loopback
    boot.extraModulePackages = lib.optionals cfg.v4l2loopback [
    ...
    boot.extraModprobeConfig = lib.optionalString cfg.v4l2loopback ''
